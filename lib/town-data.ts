...
export const townData: Record<string, TownData> = {
  ...
  winsford: {
    ...
    intro: 'Just 8 miles from Sandbach, we provide professional roofing across Winsford and the CW7 postcode area. Based in Sandbach, we offer fast response times and over 25 years of roofing experience across Cheshire.',
  ...
  northwich: {
    ...
    emergencyResponseTime: '30–45 minutes',
    intro: 'We deliver expert roofing services across Northwich and the surrounding CW8 and CW9 postcode areas. Based in Sandbach, 13 miles away, our CORC-certified team offers professional roofing for all property types across the Northwich area.',
  ...
  macclesfield: {
    ...
    intro: "We provide professional roofing services across Macclesfield and the surrounding SK10 and SK11 postcode areas. A former silk industry town set on the edge of the Pennines, Macclesfield's diverse housing stock, from Victorian terraces to modern estates, presents a wide range of roofing requirements that our experienced team handles with care.",
  ...
  knutsford: {
    ...
    roofingChallenges: "Working in Knutsford often means meeting strict planning and conservation requirements. Many properties in the town centre are listed or sit within a conservation area, requiring specialist materials such as natural Welsh slate, handmade clay tiles, and lime-based mortars, plus sensitive working methods. We always advise on the correct materials and can liaise with planning departments where required. For modern properties, the flat agricultural plain around Knutsford also means roofs face unobstructed wind-driven rain from the west.",
  ...
  biddulph: {
    ...
    intro: "We provide professional roofing services across Biddulph and the ST8 postcode area. Set on the Staffordshire Moorlands at around 200 metres above sea level, Biddulph is one of the more exposed towns in the area, and one where a reliable, locally-based roofer makes a real difference.",
  ...
  wilmslow: {
    ...
    roofingChallenges: "Wilmslow's large detached properties often have complex roof geometry, with multiple hips, valleys, dormers, and roof windows, which creates more potential leak points and demands higher levels of craft skill. Many properties also have large flat roof sections over extensions and garages. The relatively high value of these properties means the cost of a poor-quality roof job, or a delay in addressing problems, is disproportionately high. We take a thorough, detail-oriented approach to every Wilmslow project.",
  ...
  sandbach: {
    ...
    commonProblems: [
      { problem: 'Ridge tile lifting on exposed properties', solution: 'Dry ridge systems rated for Cheshire Plain wind exposure, so there is no mortar to crack.' },
    ...
    proofPoint: 'Our home town, with hundreds of roofing projects completed across CW11 over 25+ years.',
