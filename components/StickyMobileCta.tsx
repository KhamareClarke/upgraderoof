 ...
 * the homepage MobileContactBar style (icon-only rounded-full circles).
 * "Quick Form" scrolls to the inline lead form.
 */
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-lg md:hidden">
      <div className="flex items-center justify-around py-3 px-4">
        ...
        >
          <div className="w-10 h-10 bg-brand-navy/10 rounded-full flex items-center justify-center group-hover:bg-brand-navy/20 transition-colors">
